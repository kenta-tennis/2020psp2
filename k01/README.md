...
- 出力結果を 入出力結果 のところに貼り付けてください. 
- 関数の中身もmain関数の上に書くのであれば, `extern`は要りません
- 2乗したものの平均を求めていると思いますが(多分save?), ave_online関数に適切な値を渡すことでそれを求めることができます.  
また, 変数名は square_ave とかをおすすめします. 
- 実行してみましたが, 正しい結果ではありませんでした. 
    - ave_onlineなどの関数を呼び出すとき, 引数の順番を間違えています
    - var_onlineの処理にミスがあるようです.
    - 分散や平均を求める順番に注意しましょう.
    - ave3は要らない気がします.   
